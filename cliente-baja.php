...
<body>
    ...
    <form action="" class="" method="post" style="margin-left: 25%; justify-content: center;">
        <label style="margin-left: 12%; font-size: 25px; font-weight:900; font-family: cursive;" for="">ELIMINAR O MODIFICAR AUTOS</label>
        <br>
        <br>
  ...
  <tbody>';
    ...
    while($fila = mysqli_fetch_assoc($res)){    
        ...
        <dialog class='dial' id='modal".$fila['id']."'>
            ...
            <form method='post' action='./php/DAOS/procesar-baja-cliente.php?x=%d'><input class='btn btn-danger b-dial' type='submit' value='Confirmar'></form>
